...
import { SmiService } from '../../../models/smi.service';

@Component({
  templateUrl: './smi-element.component.html'
})
export class SmiElementComponent implements OnDestroy, OnInit {
  showTree = false;
  ...
  constructor(
    ...
    private readonly news: SmiService,
