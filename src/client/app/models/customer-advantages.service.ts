...
@Injectable()
export class CustomerAdvantagesService {
  private currentLanguage$: Observable<Language>;
  private resource: Resource<RecordSchema> = this.api.build('customerAdvantages');
        ...
        if (raw instanceof ApiError) {
          this.notifications
            .toast({
              ...
              timeOut: 4000,
              title: 'Ошибка API!',
              text: 'При запросе customerAdvantages произошла ошибка',
